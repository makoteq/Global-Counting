<template>
  <div class="welcome container">
    ...
    <font-awesome-icon style="font-size:3em; margin:20px" icon="users"/>
    <font-awesome-icon style="font-size:3em; margin:20px" icon="leaf"/>
    <font-awesome-icon style="font-size:3em; margin:20px" icon="handshake"/>
    <font-awesome-icon style="font-size:3em; margin:20px" icon="oil-can"/>
  </div>
</template>
